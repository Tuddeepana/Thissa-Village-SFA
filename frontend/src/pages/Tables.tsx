        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="quantity">How Many Tables?</Label>
                <Input
                  id="quantity"
                  type="number"
                  min="1"
                  ...
                  required
                  placeholder="e.g., 3 will create Table 1, Table 2, Table 3"
                />
                <p className="text-xs text-muted-foreground">
                  This will create {formData.quantity} table{formData.quantity !== 1 ? 's' : ''} named: {formData.name} 1, {formData.name} 2, etc.
                </p>
              </div>
